...
export const mascots = {
  coco: {
    name: "Coco",
    image: "https://i.imgur.com/Yx2JQL0.png", // Coconut mascot image URL
    ...
    greetings: [
      ...
      "You crushed that lesson like a coconut! 🥥"
    ]
  },
  lora: {
    name: "Lora",
    image: "https://i.imgur.com/Yx2JQL0.png", // Parrot mascot image URL
    ...
    greetings: [
      ...
      "Fantastic progress! You're speaking like a true Dushi now! ✨"
    ]
  }
};
...
export const mascotTips = {
  greetings: [
    "In Curaçao, greetings are very important! Always say 'Bon dia' when you meet someone.",
